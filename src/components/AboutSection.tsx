          ...
          <ScrollReveal>
            <div>
              ...
              <div className="space-y-5">
                ...
                <p className="body-md">He tenido el privilegio de trabajar con equipos de marketing, finanzas, ventas, operaciones... en sectores como; grandes superficies de consumo, cosmética, fintech, salud, e-commerce y SaaS, aportando siempre una perspectiva holística que conecta el oficio visual con el pensamiento estratégico.</p>
              </div>
            </div>
          </ScrollReveal>
